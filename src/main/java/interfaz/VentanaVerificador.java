...
public class VentanaVerificador extends JFrame implements ActionListener {
    ...
    //esta es la clase que contiene la vista del apartado que sirve para verificar la firma digital
    ...
    public VentanaVerificador(Inicio inicio) {
        ...
        JButton butSubClavePublica = new JButton("Cargar clave publica");
        ...
        JButton butComprobar = new JButton("Verificar");
