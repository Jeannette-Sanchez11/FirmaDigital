...
public class VentanaFirmador extends JFrame implements ActionListener {
    ...
    public VentanaFirmador(Inicio inicio) {
        ...
        JButton butSubirDocumento = new JButton("Cargar documento");
        ...
        JLabel labIngreseContrasena = new JLabel("Contraseña clave privada", SwingConstants.CENTER);
